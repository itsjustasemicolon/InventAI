...
const Home = () => {
  return (
    <div className="min-h-screen w-full px-6 py-17 flex flex-col items-center text-black">
      <main className="text-center max-w-4xl">
        ...
        <div className="flex justify-center gap-6">
          ...
          <button className="border border-blue-500 px-6 py-3 rounded-xl text-blue-500 font-semibold hover:bg-blue-500 hover:text-white transition">
            Learn More
          </button>
        </div>
      </main>
